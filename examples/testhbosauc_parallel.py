...
def calc_auc_graph(data_, orig_, count,dataname):
    ...
    aucs_rbos= [aucrbos for _ in range(len(aucs_dynamic))]
...
if __name__ == "__main__":
    ...
    alldatasets = [
        (dataset1, orig1, 500, "annthyroid"),
        (dataset2, orig2, 500, "cardio"),
        (dataset3, orig3, 500, "cover"),
        (dataset4, orig4, 500, "letter"),
        (dataset5, orig5, 500, "glass"),
        (dataset6, orig6, 500, "http"),
        (dataset7, orig7, 500, "lympho"),
        (dataset8, orig8, 500, "mammography"),
        (dataset9, orig9, 500, "mnist"),
        (dataset10, orig10, 500, "musk"),
        (dataset11, orig11, 500, "optdigits"),
        (dataset12, orig12, 500, "pendigits"),
        (dataset13, orig13, 500, "creditcard"),
        (dataset14, orig14, 500, "Annthyroid_02_v01")
    ]
    processes = []
